...
//  LinkSAppIOS
//
//  Created by Sandrine Patin on 10/07/2020.
...
class VolunteersTableViewController: UITableViewController {
    ...
    @IBOutlet var volunteersTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        volunteersTableView.register(UINib(nibName: "VolunteersTableViewCell", bundle: nil), forCellReuseIdentifier: albumsCellId)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let volunteer = self.volunteersList?[indexPath.row]
        print(volunteer)
